...
本文采用 Apple Human Interface Guidelines (HIG) [^1] 的分类方式组织，从基础到具体：Foundations → Patterns → Components。设计系统的展示方式参考了 awesome-design-md [^9] 项目，机器可读的 DESIGN.md 原文可通过 [/design.md](/design.md) 访问（很奇妙吧，加个 .md 就可以了）。
...
[^2]: [Obsidian Shiba Inu 主题](https://github.com/faroukx/Obsidian-shiba-inu-theme) - 一款暖色调 Obsidian 主题，博客配色的起点。最初让 Claude 模仿这套配色，后来逐渐走偏成了当前的「旧书页+琥珀」风格。
...
[^4]: [open 粉圓 | justfont](https://justfont.com/huninn/) - 台湾字型团队 justfont 的开源圆体字体，笔画圆润温暖，中英文都能用。
[^5]: [帶你認識「字型設計師」！ft. justfont | YouTube](https://www.youtube.com/watch?v=6ZxsXCtW2mU&t=80s) - 好客室播客第 83 期，介绍台湾字体设计师的工作和 justfont 团队的故事，第一次知道 justfont 就是通过这期节目。
